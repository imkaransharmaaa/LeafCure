...
training_set = train_datagen.flow_from_directory('C:/Users/ks228/OneDrive/Desktop/leaf_disease_detection/Dataset/train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('C:/Users/ks228/OneDrive/Desktop/leaf_disease_detection/Dataset/val', # relative path from working directoy
                                             target_size = (128, 128), 
